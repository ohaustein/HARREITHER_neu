...
namespace Europlan.Common {
	...
	public class Project : IGuiRepresentation {
		...
		public List<ProjektBilanzWrapper> GetProkjektBilanzReport() {
			...
			wrapper.Description = "Gestamt-Normw‰rmebedarf";
			wrapperList.Add(wrapper);

			wrapper = new ProjektBilanzWrapper();
			wrapper.Description = "Gesamter bereinigter W‰rmebedarf";
			wrapperList.Add(wrapper);
			...
			wrapper = new ProjektBilanzWrapper();
			wrapper.Description = "Gestamt-Raumfl‰che";
			wrapperList.Add(wrapper);

			wrapper = new ProjektBilanzWrapper();
			wrapper.Description = "Gestamt-Fuﬂbodenheizungsfl‰che";
			wrapperList.Add(wrapper);

			wrapper = new ProjektBilanzWrapper();
			wrapper.Description = "Gestamt-Wandheizungsfl‰che";
			wrapperList.Add(wrapper);

			wrapper = new ProjektBilanzWrapper();
			wrapper.Description = "Gestamt-Deckenk¸hlungsfl‰che";
			wrapperList.Add(wrapper);

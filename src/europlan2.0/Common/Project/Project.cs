...
namespace Europlan.Common
{
    ...
    public class Project : IGuiRepresentation
    {
        ...
        {
            var projectDirectoryName = Path.GetDirectoryName(Project.Instance.ProjectFileName);
            return projectDirectoryName;
        }

        public String GetProjectPlansDirectoryName()
        {
            var projectDirectoryName = Path.GetDirectoryName(Project.Instance.ProjectFileName);
            var projectPlansSubDirectoryName = GetProjectPlansSubdirectoryName();
            var projectPlansDirectoryName = Path.Combine(projectDirectoryName, projectPlansSubDirectoryName);
            return projectPlansDirectoryName;
        }

        public String GetProjectPlansSubdirectoryName()
        {
            var projectPlansSubDirectoryName = Path.GetFileNameWithoutExtension(Project.Instance.ProjectFileName) + "_plans";
            return projectPlansSubDirectoryName;
        }

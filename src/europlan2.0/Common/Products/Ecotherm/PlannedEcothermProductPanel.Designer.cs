namespace Europlan.Common {
	partial class PlannedEcothermProductPanel {
		...
		private void InitializeComponent() {
			...
			this.btnRestkaelte.TabIndex = 26;
			...
			this.btnRestwaerme.TabIndex = 25;
			...
			this.btnConnectionPipes.TabIndex = 72;
			...
			this.btnGraphical.TabIndex = 174;
			...
			this.btnGraphicalAnbindleitungen.TabIndex = 10;

...
namespace Europlan.Common {
	[XmlInclude(typeof(GraphicalHithermUnderfloorVerbindung))]
	...
	public class GraphicalHithermUnderfloorVerbindung : GraphicalHithermVerbindung, IWallVerbindungCompound<GraphicalHithermVerbindung> {

		private GraphicalHithermVerbindung startLink = null;
		private GraphicalHithermVerbindung endLink = null;

		public GraphicalHithermUnderfloorVerbindung(GraphicalHithermVerbindung startLink, GraphicalHithermVerbindung endLink) {
		...
		internal GraphicalHithermUnderfloorVerbindung() {
		}
		...
		public override void UpdateStartPoint(GraphicalHithermRegisterWrapper register, GraphicalWall owningWall, bool checkValidity) {
			this.startLink.UpdateStartPoint(register, owningWall, checkValidity);
		}

		public override void UpdateEndPoint(GraphicalHithermRegisterWrapper register, GraphicalWall owningWall, bool checkValidity) {
		...
		[XmlIgnore]
		public override HithermRegister Start {
			get { return this.startLink.Start; }
		}

		[XmlIgnore]
		public override HithermRegister End {
		...
		[XmlIgnore]
		public override HithermCircuit Circuit {
		...
		public GraphicalHithermVerbindung StartLink {
		...
		public GraphicalHithermVerbindung EndLink {

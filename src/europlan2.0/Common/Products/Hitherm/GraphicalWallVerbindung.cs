...
namespace Europlan.Common {
	...
	public abstract class GraphicalWallVerbindung : IGraphicalWallObject {
		...
		internal GraphicalWallVerbindung() {
			this.vertices = new List<Point2D>();
		}

		internal GraphicalWallVerbindung(bool finished) {
			this.vertices = new List<Point2D>();
			this.finished = finished;
		}

		public void InitializeVertices(IEnumerable<Point2D> vertices) {
		...
		/*[XmlIgnore]
		public abstract bool CircuitHasRegister {
			get;
		}*/

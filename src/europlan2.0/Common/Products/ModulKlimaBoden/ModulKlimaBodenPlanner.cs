    ...
    public partial class ModulKlimaBodenPlanner : Component, IProductPlanner
    {
        ...
        public bool PlannerClick(WW.Math.Point2D planPoint, System.Drawing.Point pointInControl, MouseButtons button)
        {
            ...
            if (this.Mode == KlimaBodenMode.KDM_LAYOUT_ADD_AREA_PICK_REFERENCE)
            {
                ...
                if (pickedModul != null)
                {
                    ...
                    double height = KlimaFlaechenModul.GetModuleHeightGraphical(KlimaFlaechenModul.ModulTypeEnum.MODUL_100_40) * this.product.AssociatedRoom.AssociatedPlan.Measure.Value;
                    double width = KlimaFlaechenModul.GetModuleWidthGraphical(KlimaFlaechenModul.ModulTypeEnum.MODUL_100_40) * this.product.AssociatedRoom.AssociatedPlan.Measure.Value;
        ...
        private double NewModulesStepX
        {
            get
            {
                ...
                {
                    stepX = KlimaFlaechenModul.GetModuleWidthGraphical(KlimaFlaechenModul.ModulTypeEnum.MODUL_100_40) * this.product.AssociatedRoom.AssociatedPlan.Measure.Value;
                    stepX += modulierendDistance * this.product.AssociatedRoom.AssociatedPlan.Measure.Value * (int)this.newModulesXDicht;
                }
                return stepX;
            }
        ...
        private int AddModulesForLayoutArea(AddModuleDelegate doIt, bool addIncomplete, bool addConnections)
        {
            ...
            double height = KlimaFlaechenModul.GetModuleHeightGraphical(KlimaFlaechenModul.ModulTypeEnum.MODUL_100_40) * measure;
            double width = KlimaFlaechenModul.GetModuleWidthGraphical(KlimaFlaechenModul.ModulTypeEnum.MODUL_100_40) * measure;

...
namespace Europlan.UnitTest {
	...
	public class ConfigurationTest {
		...
		public void TestMaterialConfiguration() {
			...
			config.Materials.Add(new Material("MAT01", "Testmaterial", "MAT01", 100, "Stk", (float)3.14, "", null, true, false));
			config.Materials.Add(new Material("MAT02", "Testmaterial 2", "MAT02", 10, "m", (float)30.14, "", null, false, false));
			config.Materials.Add(new Material("MAT03", "Testmaterial 3", "MAT03", 150, "mm²", (float)0.14, "", null, false, false));
			...
			Material material = new Material("MAT01", "Testmaterial", "MAT01", 100, "Stk", (float)3.14, "", null, true, false);
			Assert.IsTrue(config.Materials.Contains(material));
			material = new Material("MAT011", "Testmaterial", "MAT01", 100, "Stk", (float)3.14, "", null, true, false);

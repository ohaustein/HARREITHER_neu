...
namespace Europlan.Application {
	public class NumericBox : TextBox {
		...
		private static readonly Nullable<decimal>[] minValue = new Nullable<decimal>[] { null,    0,              0,    0,              0,              0 };
		private static readonly Nullable<decimal>[] maxValue = new Nullable<decimal>[] { null,   99, Int32.MaxValue,   99, Int32.MaxValue, Int32.MaxValue };
		private static readonly int[] decimalPlaces = new int[]                        {    0,    0,              1,    0,              0,              0 };
		private static readonly string[] masks = new string[]                          {  "0", "90",     "999990.9", "90",      "9999990",      "9999990" };

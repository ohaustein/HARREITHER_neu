namespace Europlan.Common {
	partial class MaterialEditorGrid {
		...
		private void InitializeComponent() {
			...
			this.Category.DataSource = this.materialCategoryGridItemBindingSource;
			this.Category.DisplayMember = "ItemName";
			this.Category.FillWeight = 250F;
			...
			((System.ComponentModel.ISupportInitialize)(this.materialCategoryGridItemBindingSource)).EndInit();

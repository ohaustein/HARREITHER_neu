...
namespace Europlan.Common {
	public class HithermWall {
		...
		public HithermWall(string id, string name, WallConstruction construction, Nullable<double> deckschicht, Nullable<double> uValue, bool bereinigen, Nullable<double> additionalInsulation, double tempBehindHeat, double tempBehindCool, bool defaultWall) {
			this.id = id;
			this.name = name;

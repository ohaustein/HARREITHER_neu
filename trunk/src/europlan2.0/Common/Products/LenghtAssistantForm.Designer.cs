namespace Europlan.Common {
	partial class LengthAssistantForm {
		...
		private void InitializeComponent() {
			...
			this.label1.Text = "Anbindeleitung für";
			// 
			// label2
			// 
			...
			// numVorlauf
			// 
			this.numVorlauf.EditType = Europlan.Common.NumericBox.NumericEditType.DEFAULT;
			...
			// numVorlaufArea
			// 
			this.numVorlaufArea.EditType = Europlan.Common.NumericBox.NumericEditType.DEFAULT;
			...
			this.numVorlaufArea.MinValue = null;
			...
			// numRuecklaufArea
			// 
			this.numRuecklaufArea.EditType = Europlan.Common.NumericBox.NumericEditType.DEFAULT;
			...
			this.numRuecklaufArea.MinValue = null;
			...
			// numRuecklauf
			// 
			this.numRuecklauf.EditType = Europlan.Common.NumericBox.NumericEditType.DEFAULT;
			...
			this.numRuecklauf.MinValue = null;

	...
	public partial class PlannedEurovalProductPanel : UserControl, IEditorUserControl {
		...
		public void UpdateControl() {
			...
			if (this.product != null) {
				(this.product.Product as EurovalProduct).ConfigureProduct(this.product.RequestedHeatLoad, this.product.RequestedCoolLoad, this.product.CalculateHeat, this.product.CalculateCool, out errorMsg, false);
			}
		...
		private void UpdateControl(FieldEnum skipFields) {
			if (this.product != null) {
				...
				bool showHeat = this.product.Product.AssociatedRoom.HeatLoad > 0 && evProduct.PlannedLayDistance != EurovalProduct.LayDistance.NONE;
				bool showCool = this.product.Product.AssociatedRoom.CoolLoad > 0 && evProduct.PlannedLayDistance != EurovalProduct.LayDistance.NONE;

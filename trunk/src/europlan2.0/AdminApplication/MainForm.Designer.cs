namespace Europlan.AdminApplication {
	partial class MainForm {
		...
		private void InitializeComponent() {
			...
			this.tabPageFloorHeating.Text = "Fußbodenheizung";
			...
			this.tsmiNewFloorConstruction.Text = "Fußbodenkonstruktion";
			...
			this.tsmiNewInsulationConstruction.Text = "Wärmedämmkonstruktion";
			...
			this.tsmiFloorConstruction.Text = "Fußbodenkonstruktionen";
			...
			this.tsmiInsulationConstruction.Text = "Wärmedämmkonstruktionen";
